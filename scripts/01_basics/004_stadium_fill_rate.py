def calculate_total_tickets_sold(ticket_sales):
...
def calculate_fill_rate(total_tickets_sold, stadium_capacity):
    return (total_tickets_sold / stadium_capacity) * 100


def print_fill_rate_summary(match_name, stadium_name, stadium_capacity, total_tickets_sold, fill_rate):
...
def main():
    ...
    total_tickets_sold = calculate_total_tickets_sold(ticket_sales)
    fill_rate = calculate_fill_rate(total_tickets_sold, stadium_capacity)

    print_fill_rate_summary(
        match_name,
        stadium_name,
        stadium_capacity,
        total_tickets_sold,
